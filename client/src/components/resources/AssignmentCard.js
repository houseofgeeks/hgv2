    ...
    return (
        <>
            <div className="first:mt-0 my-3 xs:my-0">
                <img src={status==="orange"?frame2:status==='green'?frame3:frame} alt={`title`} className="w-full" />
                <div className="relative mb-4 flex w-full flex-wrap items-stretch pt-[8px]">
                

                    { status==="red"  && <button type="button"
