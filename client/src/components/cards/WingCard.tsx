...
const WingCard = ({ title, description, wingId }: Props) => {
  return (
    <div className="w-full flex flex-col gap-2">
      <div className="w-full aspect-video bg-secondary-bg shadow-sm"></div>
      <h2 className="text-xl font-medium mt-1.5">{title}</h2>
      ...
      <Link
        ...
        className="text-primary-color w-fit flex items-center hover:underline"
      >
        Start this track
        <FiArrowUpRight />
      </Link>
