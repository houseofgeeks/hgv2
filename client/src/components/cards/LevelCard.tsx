...
const LevelCard = ({ levelId, title, count, resourceId }: Props) => {
  return (
    <Link
      href={`/resources/${resourceId}/${levelId}`}
      className="bg-secondary-bg hover:shadow-lg group items-center p-4 px-6 rounded-md gap-4 shadow flex flex-row justify-between"
    >
